...
/*
 * hook_form_alter for login_block_form (id => user_login_block)
 */
function basic_form_user_login_block_alter(&$form, &$form_state){
  
  unset($form['name']['#title']); //remove username label
  unset($form['pass']['#title']); //remove password label
